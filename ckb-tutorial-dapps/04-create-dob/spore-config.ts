...
// use `offckb system-scripts --export-style lumos` to get the below info (make sure to update it in the future)
const lumosConfig = {
  PREFIX: "ckt",
  SCRIPTS: {
    SECP256K1_BLAKE160: {
      ...
      HASH_TYPE: "type",
      TX_HASH:
        "0x3adf8c8bf04842c83cdaa21072cd3c4f869e8f7448b68d9baa409f6dc09f09b6",
      INDEX: "0x0",
      DEP_TYPE: "depGroup",
      SHORT_ID: 1,
    },
    ...
    DAO: {
      ...
      HASH_TYPE: "type",
      TX_HASH:
        "0x6141d3dc3ccd8cbe4f0870676649778dd0f0422cf19735fcdebfa003fa980a40",
      INDEX: "0x2",
      DEP_TYPE: "code",
      SHORT_ID: 2,
    },
